...
router.get("/semestre/actuel",(req,res)=>{
...
router.get("/semestre/suivant",(req,res)=>{
...
router.get("/semestre/pas-valide",(req,res)=>{
...
// Route pour changer de semestre
router.put("/semestre/changer",(req,res)=>{
